...
@ContextConfiguration(classes = { HogeServiceMethodScopeSjuTest.AppConfig.class })
public class HogeServiceMethodScopeSjuTest {
	private Logger L = LoggerFactory
			.getLogger(HogeServiceMethodScopeSjuTest.class);
	...
	public static class AppConfig {
		...
		HogeService createHogeServiceClassScope() {
			return new HogeServiceMethodScopeImpl();
		}
